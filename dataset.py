...
# with open('C:/Users/shenyue/Desktop/NLP/class project/cwisharedtask2018-teaching-master/datasets/english/English_Train.tsv','rt',encoding='utf-8') as file:
#     fieldnames = ['hit_id', 'sentence', 'start_offset', 'end_offset', 'target_word', 'native_annots','nonnative_annots', 'native_complex', 'nonnative_complex', 'gold_label', 'gold_prob']
#     reader = csv.DictReader(file, fieldnames=fieldnames, delimiter='\t')
